...
export default function Intake() {
  ...
  // Auto-save project and answers when intake completes
  useEffect(() => {
    ...
    const save = async () => {
      ...
      try {
        ...
        // Persist structured answers for future querying
        const adapter = getStorageAdapter()
        await adapter.saveProjectAnswers(project.id, user!.id, {
          auditType: answers.auditType,
    ...
    save()
  }, [isComplete, answers, savedProjectId, saveProject, user])
